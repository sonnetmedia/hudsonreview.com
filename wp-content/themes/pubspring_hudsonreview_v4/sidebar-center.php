...
<li class="show_list_years active"><a href="#" onclick="return false;"> Issue</a></li>  
<li class="show_list_categories"><a href="#" onclick="return false;"> Genre</a></li>
<li class="show_list_authors"><a href="#" onclick="return false;"> Author</a></li> 
