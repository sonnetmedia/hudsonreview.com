...
<div class="container page_body">
	<div class="row">
		...
		<div class="col col-span-7 pull-up-70">
...
.border_bottom {
	margin-bottom:30px;border-bottom:1px solid #dadada;padding-bottom:30px;
}
</style>


<div class="col col-span-2" style="margin-top:30px;">
...
<div class="border_bottom">    
    <a href="<?php if($related_reviews) {echo '/?p='.$related_reviews;}else {the_permalink();} ?>">
...
endwhile; endif; 			wp_reset_postdata(); ?>
	...
	<p class="metadata"><a href="/works-reviewed/">More Works Reviewed</a></p>
</div>



<div class="col col-span-3 small_text" style="border-left:1px solid #dadada;margin-top:30px;">
