...
//require_once('functions/pubspring-page-open.php'); Moved these to header with direct includes
...
//require_once('functions/social-follow-buttons.php'); not using
//META SEO
...
echo '<span class="inline metadata small" style="font-size:9px;font-weight:300;">Full Text</span>';
}
// CREATE SHORTCODE
function add_full_text_button() {
return '<span class="inline label label-primary metadata small" style="font-size:9px;font-weight:300;color:white;">Full Text</span>';
}
